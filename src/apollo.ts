...
const httpLink = new HttpLink({
  uri: isDev ? "http://localhost:4000/graphql" : "https://briannuberserver.now.sh/graphql"
});
...
const wsLink = new WebSocketLink({
  ...
  uri: isDev ? "ws://localhost:4000/subscription" : "ws://briannuberserver.now.sh/subscription"
});
