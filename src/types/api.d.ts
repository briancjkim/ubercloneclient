...
export interface getDrivers_GetNearbyDriver_drivers {
  __typename: "User";
  id: number;
  lastLat: number | null;
  lastLng: number | null;
...
export interface getDrivers_GetNearbyDriver {
  __typename: "GetNearbyDriverResponse";
  ok: boolean;
  drivers: (getDrivers_GetNearbyDriver_drivers | null)[] | null;
}

export interface getDrivers {
  GetNearbyDriver: getDrivers_GetNearbyDriver;
}
